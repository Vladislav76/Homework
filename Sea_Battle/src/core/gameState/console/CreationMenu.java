...
//import core.mapObject.User;
//import core.scanner.ConsoleScanner;
////import core.boot.core.boot.PluginLoader;
//import core.boot.PluginFactory;
	...
	public void initialize(Message message) {
		...
		if (message instanceof GameSettingsMessage) {
			...
			if (gameMode == ModeMenu.PLAYER_VS_AI_MODE) {
				players = new Player[] {new User(in), aiFactory.instanceAI(PluginFactory.RANDOM_AI)};
			}
			else {
